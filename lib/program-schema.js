...
function collectSingleProgramErrors(program, options) {
  ...
  if (program.repoUrl != null && program.repoUrl !== "" && !/^https:\/\//.test(String(program.repoUrl))) {
    errors.push(operatorFix("Program " + label + " repoUrl must be https when set.", "programs[].repoUrl", "https://github.com/..."));
  }
